...
const blogs = () => {
    return (
        <div className='px-16'>
            <h2 className='text-5xl  text-white font-medium my-6'>Blogs</h2>
            <div className="dark:bg-gray-800 dark:text-gray-50 mx-5 rounded-xl overflow-hidden my-4">
                <div className="container grid grid-cols-12 mx-auto dark:bg-gray-900">
                    ...
                    <div className="flex flex-col p-6 col-span-full row-span-full lg:col-span-8 lg:p-10">
                        <div className="flex justify-start">
                            <span className="px-2 py-1 text-xs rounded-full dark:bg-amber-400 dark:text-gray-900">Label</span>
                        </div>
                        ...
                        <a rel="noopener noreferrer" href="#" className="inline-flex items-center pt-2 pb-6 space-x-2 text-sm dark:text-amber-400">
                            <span>Read more</span>
